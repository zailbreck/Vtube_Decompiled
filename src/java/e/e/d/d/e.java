...
final class e {
    ...
    public static <T> T[] a(T[] arrobject, int n2, T t2) {
        if (n2 + 1 > arrobject.length) {
            Object[] arrobject2 = (Object[])Array.newInstance((Class)arrobject.getClass().getComponentType(), (int)e.a(n2));
