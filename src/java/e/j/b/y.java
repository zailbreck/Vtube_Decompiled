...
SurfaceHolder.Callback {
    ...
    static {
        Log.isLoggable((String)"VideoSurfaceView", (int)3);
    }
    ...
    public boolean a(k k2) {
        this.d = k2;
        if (k2 != null && this.b()) {
            k2.a(this.b).a((Runnable)new a((y)this), e.e.d.a.b((Context)this.getContext()));
            return true;
        }
        return false;
    }
    ...
    public void surfaceCreated(SurfaceHolder surfaceHolder) {
        ...
        if (this.c != null) {
            ...
            this.c.a((View)this, rect.width(), rect.height());
        }
    }
