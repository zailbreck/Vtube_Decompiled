...
public class b {
    ...
    public static void a(JSONObject jSONObject, b.a a2) {
        f.e.a.a.b.f.c c2 = a2.a();
    ...
    public static void b(JSONObject jSONObject, String string) {
        try {
            jSONObject.put("notVisibleReason", (Object)string);
            return;
        }
        catch (JSONException jSONException) {
            c.a("Error with setting not visible reason", (Exception)((Object)jSONException));
            return;
        }
    }
