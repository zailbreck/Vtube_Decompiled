...
class DisplayListenerProxy {
    ...
    void onPostWebViewInitialization(final DisplayManager displayManager) {
        final ArrayList<DisplayManager.DisplayListener> arrayList = DisplayListenerProxy.yoinkDisplayListeners(displayManager);
        arrayList.removeAll(this.listenersBeforeWebView);
